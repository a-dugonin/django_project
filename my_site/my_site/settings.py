...
SECRET_KEY = 'django-insecure--z^ey!=w1x+*)8q%xfcj)@g%%c5k_gqh-(0bu)zmo4yd50s%i7'
...
LOGIN_REDIRECT_URL = reverse_lazy("good_shop:about_user")
LOGIN_URL = reverse_lazy("good_shop:login")
